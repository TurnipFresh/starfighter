...
helpers.polarToCartesian = function (vectorLength, vectorDirection) {
    return {
...
helpers.radToDeg = function (radians) {
    return radians * (180 / Math.PI);
},
// Convert degrees to radians
helpers.degToRad = function (degrees) {
    return degrees * Math.PI / 180;
},
// Generate a random number between a fixedrange
helpers.random = function (min, max, round) {
