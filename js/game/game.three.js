...
window.game.three = function () {
    ...
    _three.cameraSizeConstraint = null;
    ...
    _three.destroy = function () {

    };

    _three.setup = function () {
        // Setup main scene
    ...
    _three.render = function () {
        // Update the scene
        _three.renderer.render(_three.scene, _three.camera);
    };

    _three.onWindowResize = function () {
    ...
    _three.createModel = function (jsonData, scale, materials, isGeometry) {
    ...
    _three.createCannonGeometry = function (geometry, scale) {
    ...
    _three.createCannonHalfExtents = function (geometry) {
