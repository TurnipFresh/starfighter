/// <reference path="game.helpers.js" />
/// <reference path="game.models.async.js" />
/// <reference path="game.models.js" />
/// <reference path="game.static.js" />
/// <reference path="game.three.js" />
/// <reference path="game.ui.js" />
/// <reference path="../libs/three.js" />
/// <reference path="../libs/stats.min.js" />
/// <reference path="../libs/detector.js" />
/// <reference path="game.events.js" />
/// <reference path="../libs/cannon.js" />

/*
*
*   @author starfighterxyz
*   @module game
**/
        ...
        */
		player: {
            ...
            */
		    ...
		    /**
             * @member model
             * @description Player mass which affects other rigid bodies in the world
            */
			mass: 6,
            ...
            */
			...
			update: function() {
				...
				if (_game.starfield) {
				    //_game.starfield.rotation.x += 0.0005;
				    //_game.starfield.rotation.y += 0.01;
				}
			...
			processUserInput: function() {
				...
				if (_events.keyboard.pressed[_game.player.controlKeys.forward]) {
					...
					_game.player.updateOrientation(_game.player.updateOrientation());
		...
		level: {
			...
			create: function() {
				...
				_cannon.createRigidBody({
					...
					meshMaterial: new THREE.MeshLambertMaterial({ color: window.game.static.colors.black, transparent: true, opacity: 0.5 }),
				...
				// Grid Helper
				var grid = new THREE.GridHelper(floorSize, floorSize / 16);
				grid.position.z = 0.5;
				...
				_game.starfield = new THREE.Object3D();
				var numStars = getRandom(500, 1000);
				for (var i = 0 ; i < numStars; i++) {
				    var radius = 3;
				    var sphereGeometry = new THREE.SphereGeometry(radius, 16, 8);
				    var sphereMaterial = new THREE.MeshLambertMaterial({ color: 0xFFFFFF });
				    var sphere = new THREE.Mesh(sphereGeometry, sphereMaterial);
				    sphere.position.x = getRandom(-2000, 2000);
				    sphere.position.y = getRandom(-2000, 2000);
				    sphere.position.z = getRandom(-2000, 2000);
				    _game.starfield.add(sphere);
				}

				_game.starfield.position.z = 0.5;
				_game.starfield.position.x = window.game.helpers.degToRad(90);

				_three.scene.add(_game.starfield);
